...
.venv/bin/pytest                      # part of 1141 tests, no network, no live service
...
Expected: all clean, 1141 passing across the four, conformance `PASS`. CI runs the same four on
