...
.venv/bin/pytest                      # part of 1118 tests, no network, no live service
...
Expected: all clean, 1118 passing across the four, conformance `PASS`. CI runs the same four on
