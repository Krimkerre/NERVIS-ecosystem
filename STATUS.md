...
.venv/bin/pytest                      # part of 1100 tests, no network, no live service
...
Expected: all clean, 1100 passing across the four, conformance `PASS`. CI runs the same four on
