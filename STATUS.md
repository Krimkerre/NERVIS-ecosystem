...
.venv/bin/pytest                      # part of 1106 tests, no network, no live service
...
Expected: all clean, 1106 passing across the four, conformance `PASS`. CI runs the same four on
