...
.venv/bin/pytest                      # part of 1778 tests, no network, no live service
...
Expected: all clean, 1778 passing across the four, conformance `PASS`. CI runs the same four on
