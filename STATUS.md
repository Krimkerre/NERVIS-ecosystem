...
.venv/bin/pytest                      # part of 1209 tests, no network, no live service
...
Expected: all clean, 1209 passing across the four, conformance `PASS`. CI runs the same four on
