...
.venv/bin/pytest                      # part of 1120 tests, no network, no live service
...
Expected: all clean, 1120 passing across the four, conformance `PASS`. CI runs the same four on
