...
.venv/bin/pytest                      # part of 1132 tests, no network, no live service
...
Expected: all clean, 1132 passing across the four, conformance `PASS`. CI runs the same four on
