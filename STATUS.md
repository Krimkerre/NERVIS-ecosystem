...
.venv/bin/pytest                      # part of 1167 tests, no network, no live service
...
Expected: all clean, 1167 passing across the four, conformance `PASS`. CI runs the same four on
