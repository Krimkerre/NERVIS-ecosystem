...
.venv/bin/pytest                      # part of 1465 tests, no network, no live service
...
Expected: all clean, 1465 passing across the four, conformance `PASS`. CI runs the same four on
