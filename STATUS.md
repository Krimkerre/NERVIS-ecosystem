...
.venv/bin/pytest                      # part of 1455 tests, no network, no live service
...
Expected: all clean, 1455 passing across the four, conformance `PASS`. CI runs the same four on
