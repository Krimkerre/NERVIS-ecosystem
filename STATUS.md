...
.venv/bin/pytest                      # part of 1442 tests, no network, no live service
...
Expected: all clean, 1442 passing across the four, conformance `PASS`. CI runs the same four on
