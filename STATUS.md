...
.venv/bin/pytest                      # part of 1453 tests, no network, no live service
...
Expected: all clean, 1453 passing across the four, conformance `PASS`. CI runs the same four on
