...
.venv/bin/pytest                      # part of 1110 tests, no network, no live service
...
Expected: all clean, 1110 passing across the four, conformance `PASS`. CI runs the same four on
