...
.venv/bin/pytest                      # part of 1529 tests, no network, no live service
...
Expected: all clean, 1529 passing across the four, conformance `PASS`. CI runs the same four on
