...
.venv/bin/pytest                      # part of 1188 tests, no network, no live service
...
Expected: all clean, 1188 passing across the four, conformance `PASS`. CI runs the same four on
