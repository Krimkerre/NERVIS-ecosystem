...
.venv/bin/pytest                      # part of 1175 tests, no network, no live service
...
Expected: all clean, 1175 passing across the four, conformance `PASS`. CI runs the same four on
