...
.venv/bin/pytest                      # part of 1111 tests, no network, no live service
...
Expected: all clean, 1111 passing across the four, conformance `PASS`. CI runs the same four on
