...
.venv/bin/pytest                      # part of 1122 tests, no network, no live service
...
Expected: all clean, 1122 passing across the four, conformance `PASS`. CI runs the same four on
