...
.venv/bin/pytest                      # part of 1511 tests, no network, no live service
...
Expected: all clean, 1511 passing across the four, conformance `PASS`. CI runs the same four on
