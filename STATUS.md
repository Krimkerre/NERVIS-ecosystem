...
.venv/bin/pytest                      # part of 1709 tests, no network, no live service
...
Expected: all clean, 1709 passing across the four, conformance `PASS`. CI runs the same four on
