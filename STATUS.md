...
.venv/bin/pytest                      # part of 1194 tests, no network, no live service
...
Expected: all clean, 1194 passing across the four, conformance `PASS`. CI runs the same four on
