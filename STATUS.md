...
.venv/bin/pytest                      # part of 1441 tests, no network, no live service
...
Expected: all clean, 1441 passing across the four, conformance `PASS`. CI runs the same four on
