...
.venv/bin/pytest                      # part of 1202 tests, no network, no live service
...
Expected: all clean, 1202 passing across the four, conformance `PASS`. CI runs the same four on
