...
| **M5b** IMPLEMENTED | SIRVIS integration, launch half — benchmark submit, cancel, live progress. **Blocked on SIRVIS M14**, which owns the job queue: `sirvis.benchmarks.jobs@1` is advertised *unavailable* and §1 forbids inventing the endpoint | A benchmark launches through the SIRVIS API; progress streams live |
