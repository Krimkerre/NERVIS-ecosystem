...
**Codex** (M28 — specified 13 September 2026, not built): under the headline tiles, one line from
...
(§8, §16.2). It shows tasks and allowance and controls nothing.
...
**Codex** (M28 — specified 13 September 2026; only the sign-in is built, see the end of this paragraph): the RAVIS Dashboard carries a Codex card
...
returns the sign-in page's address; every answer is marked `no-store`.
