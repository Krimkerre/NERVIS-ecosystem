...
**Codex** (M28 — specified 13 September 2026; built the same day without task counts, see below): under the headline tiles, one line from
...
(§8, §16.2). It shows tasks and allowance and controls nothing. As built in 0.28.13 it shows Codex's
state and what is left in the tightest window with its reset, for example *"signed in · 62% left in
the 5-hour window · resets 04:30 (in 2 h 10 min)"*; task counts wait for RAVIS to list runs (R3).
...
**Codex** (M28 — specified 13 September 2026; the sign-in and the allowance are built, see the end of this paragraph): the RAVIS Dashboard carries a Codex card
...
rather than deriving them (twelve since 13 September 2026, five of them Codex's sign-in), so one
...
| **RAVIS** | Chat and routing views disable; SIRVIS and Clarvis direct-provider behaviour continue; the Codex card and Overview line go absent, and no Codex task can run, since RAVIS hosts them (M28 and RAVIS M29, not built) |
