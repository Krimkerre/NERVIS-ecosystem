...
| ~~**M5**~~ **STRUCK 18 September 2026** — owner's decision on the unbuilt parts | SDK foundation | TypeScript and Python clients | A Node client can reach health, system, models, runtime |
...
| ~~**M17**~~ **STRUCK 18 September 2026** — owner's decision on the unbuilt parts | Configuration sweeps | Model, context and runtime-flag matrix expansion with warnings | Expanded run count shown before execution |
| ~~**M18**~~ **STRUCK 18 September 2026** — owner's decision on the unbuilt parts | Advanced quality suites | Coding, reasoning, structured output, long-context, tool use | — |
